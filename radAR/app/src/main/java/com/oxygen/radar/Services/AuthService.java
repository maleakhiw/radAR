...
//    Retrofit retrofit;
    ...
    public static String getToken(Context context) {
        SharedPreferences prefs = context.getSharedPreferences("com.oxygen.radar", Context.MODE_PRIVATE);
    ...
    public AuthService(AuthApi authApi, Context context) {
        this.prefs = context.getSharedPreferences("com.oxygen.radar", Context.MODE_PRIVATE);
